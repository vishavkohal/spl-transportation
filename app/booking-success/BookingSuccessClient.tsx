    ...
    w.document.write(`
      ...
      <html>
        ...
        <body>
          ...
          <div class="section">
            ...
            ${
              booking.pickupAddress
                ? `<div><span class="label">Pickup address:</span><span class="value">${booking.pickupAddress}</span></div>`
                : ''
            }
            <div><span class="label">To:</span><span class="value">${booking.dropoffLocation}</span></div>
            ${
              booking.dropoffAddress
                ? `<div><span class="label">Dropoff address:</span><span class="value">${booking.dropoffAddress}</span></div>`
                : ''
            }
            ...
            <div><span class="label">Child Seat:</span><span class="value">${
          ...
          <h2>Payment</h2>
          <div class="section">
            <div><span class="label">Total:</span><span class="value">${currency} ${booking.totalPrice.toFixed(
              2
            )}</span></div>
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-5 mt-4 text-sm">
          <div className="space-y-3">
            <div>
              ...
              {booking.pickupAddress && (
                <p className="text-xs text-gray-500 mt-1">Pickup: {booking.pickupAddress}</p>
              )}
              {booking.dropoffAddress && (
                <p className="text-xs text-gray-500">Dropoff: {booking.dropoffAddress}</p>
              )}
            </div>
