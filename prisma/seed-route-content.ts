/**
 * Seed script to migrate hardcoded route page content into the database.
 *
 * Usage:
 *   npx tsx prisma/seed-route-content.ts
 */
...
// ─── Hardcoded content (copied from app/lib/routePageContent.ts) ───

type RoutePageContentData = {
    intro: {
        h2: string;
        paragraphs: string[];
        bullets: string[];
...
const CONTENT: Record<string, RoutePageContentData> = {
    "cairns airport__port douglas": {
        intro: {
            h2: "Cairns Airport to Port Douglas: Safe, Reliable, and Premium Ride Transfer Services from SPL Transportation",
            paragraphs: [
            ...
            cta: "Book your Cairns Airport to Port Douglas transfer with SPL Transportation today!",
        },
        destination: {
            h3: "Why Visit Port Douglas from Cairns?",
            paragraphs: [
        ...
        travelOptions: {
            h4: "Travel Options from Cairns Airport to Port Douglas",
            paragraphs: [
        ...
        whyUs: {
            ...
            cta: "Reserve your Port Douglas transfer with confidence. Book now!",
        },
        faqs: [
            { question: "Why should you use SPL Transportation to get from Cairns Airport to Port Douglas transfers?", answer: "SPL Transportation will pick you up from Cairns Airport and take you to Port Douglas on schedule and in luxury. SPL Transportation makes sure your trip starts off without any stress by providing skilled local drivers, clean vehicles and direct hotel drop-off." },
            { question: "How far away is Port Douglas from the airport in Cairns?", answer: "About 65 kilometers separate Cairns Airport from Port Douglas. The trip is pleasant and beautiful with SPL Transportation. It takes about 60 to 75 minutes along the seaside highway." },
            { question: "Does SPL Transportation offer private rides to and from the airport?", answer: "Yes, SPL Transportation specializes in private Cairns Airport to Port Douglas transfers. You'll have a direct non-stop ride with complete privacy, which is great for families couples and business visitors." },
            { question: "Can you use SPL Transportation for flights that leave early in the morning or late at night?", answer: "Absolutely. SPL Transportation offers airport transfers 24/7 so you can book ahead of time if you need to arrive early or leave late." },
            { question: "Is it possible to book my transfer from Cairns Airport to Port Douglas ahead of time with SPL Transportation?", answer: "Yes, it is best to book in advance to make sure you can get what you want at a set price. If you book ahead of time with SPL Transportation, your driver will be ready for you when you arrive." },
            { question: "Is SPL Transportation good for moving groups?", answer: "Yes SPL Transportation has big vehicles for group transfers so families and bigger groups can travel comfortably with their bags." },
            { question: "Do they have child seats for airport transfers?", answer: "Yes, you can get child seats and booster seats if you ask for them. Please let SPL Transportation know when you book so that we can get your car ready." },
            { question: "Will SPL Transportation take me right to my hotel in Port Douglas?", answer: "Yes, SPL Transportation will pick you up and drop you off at your hotel or resort wherever in Port Douglas for a smooth trip." },
            { question: "What is remarkable about the drive from Cairns to Port Douglas?", answer: "The Captain Cook Highway which has stunning views of the ocean and jungle is the route. When you travel with SPL Transportation, you can relax and enjoy one of Australia's most beautiful roads." },
            { question: "Is SPL Transportation a safe and legal way to go around?", answer: "Yes SPL Transportation is a fully licensed and insured transportation company that puts passenger safety professional service and high travel standards first." },
        ],
    },

    "cairns airport__palm cove": {
        intro: {
            h2: "Cairns Airport to Palm Cove Transfers: Comfortable, Fast & Reliable Private Rides",
            paragraphs: [
            ...
            cta: "Book your Cairns Airport to Palm Cove transfer with SPL Transportation today!",
        },
        destination: {
            h3: "Why Visit Palm Cove?",
            paragraphs: [
        ...
        travelOptions: {
            h4: "Best Way to Travel from Cairns Airport to Palm Cove",
            paragraphs: [
        ...
        whyUs: {
            h2: "Why Choose SPL Transportation for Palm Cove Transfers?",
            paragraphs: [
            ...
            cta: "Enjoy a smooth start to your Palm Cove holiday. Book your transfer now!",
        },
        faqs: [
            { question: "How can I go from Cairns Airport to Palm Cove the easiest way?", answer: "A private transfer with SPL Transportation that you reserve ahead of time is the easiest and most reliable approach. You can get picked up right at Cairns Airport and taken straight to your hotel or resort in Palm Cove." },
            { question: "How long does it take to get from Cairns Airport to Palm Cove Transfers?", answer: "Traffic can make the trip take anything from 20 to 30 minutes. SPL Transportation makes sure that packages arrive on time by using the fastest coastal routes." },
            { question: "Does SPL Transportation provide private rides to Palm Cove?", answer: "Yes, SPL Transportation offers private trips from Cairns Airport to Palm Cove Transfers that are only for you. This is great for couples families and people who want privacy and ease." },
            { question: "Can you get from Cairns Airport to Palm Cove at any time of day or night?", answer: "Yes SPL Transportation offers airport transfer services around the clock including early-morning and late-night flight arrivals with advance booking." },
            { question: "Can I schedule my Palm Cove airport transfer ahead of time with SPL Transportation?", answer: "Absolutely. Pre-booking guarantees availability, set prices, and peace of mind, especially during busy holiday times in Palm Cove." },
            { question: "Is SPL Transportation good for moving families and groups?", answer: "Yes, SPL Transportation has big cars for families and groups, and they have plenty of room for suitcases, strollers, and other travel items." },
            { question: "Do you have kid seats for transfers to Palm Cove?", answer: "Yes, you can ask for child seats and booster seats. When you book with SPL Transportation, just tell them what you need." },
            { question: "Will SPL Transportation take me straight to my Palm Cove resort?", answer: "Yes, SPL Transportation will pick you up and drop you off right at your Palm Cove hotel, resort, or vacation apartment." },
            { question: "How much does it cost to get from Cairns Airport to Palm Cove?", answer: "The price depends on the size of the group and the type of vehicle. When you book in advance, SPL Transportation has clear, fair rates with no extra fees." },
            { question: "Why should you choose SPL Transportation to go to and from the Palm Cove airport?", answer: "SPL Transportation is known for its competent drivers clean cars on-time service, and knowledge of the area which makes getting to Palm Cove easy and stress-free." },
        ],
    },

    "cairns airport__cairns city": {
        intro: {
            h2: "Cairns Airport to Cairns City: Ensure a Smooth, Stress-Free and Seamless Travel Experience with SPL Transportation",
            paragraphs: [
            ...
            cta: "Book your reliable ride transfer from Cairns Airport to Cairns City with SPL Transportation!",
        },
        destination: {
            h3: "Why is Cairns City One of the Best Travel Destinations in Australia?",
            paragraphs: [
        ...
        travelOptions: {
            h4: "What Are the Different Ways to Travel from Cairns Airport to Cairns City?",
            paragraphs: [
        ...
        whyUs: {
            ...
            cta: "Ensure a smooth and stress-free Cairns Airport to Cairns City transfer with SPL Transportation. Book your ride now!",
        },
        faqs: [
            { question: "How can I get from Cairns Airport to Cairns City Transfers the quickest?", answer: "SPL Transportation's private airport shuttle is the quickest and easiest way to get to your destination. You will be picked up from Cairns Airport and taken straight to your hotel or other place to stay in Cairns City." },
            { question: "How long does it take to get from Cairns Airport to Cairns City?", answer: "It typically takes 10 to 15 minutes to travel from Cairns Airport to Cairns City, although this time may vary depending on traffic conditions. SPL Transportation ensures that routes are rapid and efficient, allowing people to arrive quickly." },
            { question: "Does SPL Transportation offer private rides to and from Cairns City airport?", answer: "Yes, SPL Transportation specializes in private, door-to-door airport transfers to Cairns City. This is great for business travelers, families, and tourists." },
            { question: "Are there shuttles from Cairns Airport to Cairns City 24 hours a day, seven days a week?", answer: "Yes, SPL Transportation runs all day, every day. With advance booking, they can pick you up and drop you off at any time of day or night." },
            { question: "Is it possible to reserve my Cairns Airport to Cairns City transfer in advance?", answer: "Absolutely. Booking ahead of time with SPL Transportation guarantees availability, a set price, and no wait time when you get to the airport." },
            { question: "Is SPL Transportation good for dropping people off at hotels and resorts in Cairns City?", answer: "Yes, SPL Transportation will drop you off directly at any hotel resort apartment or company in Cairns City." },
            { question: "Does SPL Transportation have car seats for kids when they take them to the airport?", answer: "Yes, you can ask for child seats and booster seats. Please let SPL Transportation know when you make your reservation so that they can make the right plans." },
            { question: "How much luggage may I bring on a transport to Cairns City?", answer: "SPL Transportation trucks have a lot of room for suitcases, backpacks and travel items. If you have a party or extra luggage you can have a bigger vehicle." },
            { question: "Is SPL Transportation a safe and legal way to go around?", answer: "Yes, SPL Transportation is a fully licensed insured, and safe transportation company so you can be confident that your trip will be safe and comfortable." },
            { question: "Why should you use SPL Transportation to get from Cairns Airport to Cairns City?", answer: "SPL Transportation is a reliable choice for airport transfers since they always arrive on time, have skilled drivers, clean vehicles, clear pricing, and local knowledge." },
        ],
    },

    "port douglas__cairns airport": {
        intro: {
        ...
        faqs: [
            { question: "What is the Distance Between Port Douglas and Cairns Airport?", answer: "The distance between Port Douglas and Cairns Airport is 66 Kms, approximately 1 hour 6 minutes journey via the Captain Cook Highway/ State Route 44." },
            { question: "What are the landmarks along the route from Port Douglas to Cairns Airport?", answer: "The landmarks along the route are Four Mile Beach, Captain Cook Highway, Macrossan Street, Crystal Brook Marina, and Cairns Airport (Domestic and International)." },
        ],
    },

    "palm cove__cairns airport": {
        intro: {
        ...
        faqs: [
            { question: "What is the distance between Palm Cove and Cairns Airport?", answer: "The road distance between Palm Cove and Cairns Airport is 24.8 Kms via Captain Cook Highway / State Route 44 and National Route 1. It takes around 25 minutes." },
            { question: "What are the various landmarks in the route from Palm Cove to Cairns Airport?", answer: "Various landmarks are Palm Cove Beach, Palm Cove Jetty, Captain Cook Highway, Clifton Beach, and Cairns Airport (Domestic and International)." },
        ],
    },

    "cairns city__palm cove": {
        intro: {
        ...
        faqs: [
            { question: "What are the various landmarks for the Cairns City to Palm Cove Transfers?", answer: "Various landmarks are Cairns Marina, Palm Cove Jetty, Palm Cove Beach, Clifton Beach, Lagoon Precinct, and Cairns Esplanade." },
            { question: "What is the distance between Cairns City and Palm Cove?", answer: "The distance between Cairns City and Palm Cove is approximately 25 to 27 kilometers (about 16-17 miles). In addition, the drive typically takes between 25 and 30 minutes, depending on traffic. It is commonly accessed via the Captain Cook Highway." },
        ],
    },
};
...
async function main() {
    console.log("🌱 Seeding route page content...\n");
    ...
    for (const route of routes) {
        const key = `${route.from.toLowerCase()}__${route.to.toLowerCase()}`;
        const content = CONTENT[key];

        if (!content) {
            console.log(`  ⏭  No hardcoded content for "${route.from} → ${route.to}" — skipped.`);
            skipped++;
            continue;
        }

        // Upsert: create or update
        await prisma.routePageContent.upsert({
        ...
        console.log(`  ✅ Seeded content for "${route.from} → ${route.to}"`);
        seeded++;
    }
